...
public record All( //
  ...
  public All(final byte[] message) {
    this( //
        Data.toFloat(message, Index.DATA.get() + 0), //
        Data.toFloat(message, Index.DATA.get() + 4), //
        Data.toFloat(message, Index.DATA.get() + 8), //
        Data.toFloat(message, Index.DATA.get() + 12), //
        Data.toFloat(message, Index.DATA.get() + 16), //
        Data.toFloat(message, Index.DATA.get() + 20), //
        Data.toFloat(message, Index.DATA.get() + 24), //
        createGroups(message, Index.DATA.get() + 28), //
        Data.toFloat(message, Index.DATA.get() + 76), //
        Data.toFloat(message, Index.DATA.get() + 80), //
        Data.toFloat(message, Index.DATA.get() + 84), //
        Data.toFloat(message, Index.DATA.get() + 88), //
        Data.toFloat(message, Index.DATA.get() + 92), //
        Data.uint8(message, Index.DATA.get() + 96), //
        Data.uint8(message, Index.DATA.get() + 97), //
        Data.bool(message, Index.DATA.get() + 98), //
        Data.toFloat(message, Index.DATA.get() + 99), //
        Data.toFloat(message, Index.DATA.get() + 103), //
        ...
        Data.toFloat(message, Index.DATA.get() + 110), //
        Data.toFloat(message, Index.DATA.get() + 114) //
    );
  }
